...
class ml100k(Dataset):
    ...
    data_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'ml100k')
    ...
    def __init__(self, initialized=True):
        ...
        if not self.initialized:
            print('Got raw ml100k data, initializing...')
        ...
        print('Got hdf ml100k data set, getting metadata...')
